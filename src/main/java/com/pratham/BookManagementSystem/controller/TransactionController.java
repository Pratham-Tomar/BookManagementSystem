...
public class TransactionController {
    ...
    public ResponseEntity<Transaction> borrowBook(@PathVariable int userId, @PathVariable int bookId,
    ...
    public ResponseEntity<Transaction> returnBook(@PathVariable int userId, @PathVariable int bookId,
                                                  @RequestBody String remarks) {
